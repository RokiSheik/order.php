  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Projects</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="orders.php">All Projects</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Past Projects</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">List of your past Project with details</p>
        ...
        while($row = mysqli_fetch_array($sql))
        {
            ...
            while($row1 = mysqli_fetch_array($sql1))
            {
                ...
                echo '<tr>
                        ...
                        <td>'.$row1['quantity'].'</td>
                        <td>Rs. '.$row1['price'].'</td>
                        <td><img src="'.$item_image.'" style="width:100px;height:auto;"></td>
                    </tr>';
                $id = $row1['order_id'];
            }
            echo '</tbody>
    ...
    echo '<li class="collection-item">
              <div class="row">
                  <div class="col s12 m12 l12">
                      ...
                      <img src="'.$row['image'].'" style="max-width: 100%; height: auto;"/>
                  </div>
              </div>
          </li>';
}
